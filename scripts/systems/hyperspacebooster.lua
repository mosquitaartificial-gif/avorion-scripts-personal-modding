...
function getBonuses(seed, rarity, permanent)
    ...
    -- probability for bonuses being used
    local numBonuses = 1
...
function getDescriptionLines(seed, rarity, permanent)
    return
    {
        {ltext = "Hyperspace System"%_t, rtext = "", icon = ""},
        {ltext = "Boosts effectiveness of your hyperspace engine"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)},
    }
end
