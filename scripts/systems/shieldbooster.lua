...
function getDescriptionLines(seed, rarity, permanent)
    ...
    table.insert(texts, {ltext = "Shield System"%_t})
    table.insert(texts, {ltext = "Boosts effectiveness of your shields"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)})
