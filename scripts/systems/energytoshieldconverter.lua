...
function getDescriptionLines(seed, rarity, permanent)
    return
    {
        {ltext = "Shield System"%_t},
        {ltext = "Boosts effectiveness of your shields"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)},
        {ltext = ""},
