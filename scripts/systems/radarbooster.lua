...
function getDescriptionLines(seed, rarity, permanent)
    ...
    table.insert(texts, {ltext = "Radar System"%_t})
    table.insert(texts, {ltext = "Boosts effectiveness of your radar scanner"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)})
