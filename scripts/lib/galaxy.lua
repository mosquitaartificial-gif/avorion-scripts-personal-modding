...
function Balancing_GetHighestAvailableMaterialByProbability(x, y, minPercentage)
    local materialProbabilities = Balancing_GetMaterialProbability(x, y)
    local highestProbabilityByProbability = 0
    local result = 0
    for material, probability in pairs(materialProbabilities) do
        if probability >= minPercentage and probability > highestProbabilityByProbability then
            result = material
            highestProbabilityByProbability = probability
        end
    end
