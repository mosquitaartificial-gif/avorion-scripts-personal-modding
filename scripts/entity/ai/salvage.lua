...
function SalvageAI.instance.getSecondaryHarvestMaterial(ship)
    ...
    -- only consider turrets that can be used
    ...
    -- only consider fighters if ship has pilots
...
function SalvageAI.instance.getNoWeaponsError()
    return "No usable turrets or fighters to salvage."%_T
end
...
function SalvageAI.instance.getNoCaptainError()
    return "Your craft %s needs a captain to continue salvaging."%_T
end
