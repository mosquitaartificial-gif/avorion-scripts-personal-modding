...
function interactionPossible(playerIndex, option)
    ...
    return CheckFactionInteraction(playerIndex, -45000, "We don't want anything to do with you."%_t)
end
...
function initUI()
    ScriptUI():registerInteraction("Who are you?"%_t, "onWhoAreYou", 10)
...
function makeIntroDialog()
    ...
    d1_WaitAreYouActua.answers = {
        ...
        {answer = "I'll be going now."%_t, followUp = d8_FarewellThen}
    }
...
function makeDialog()
    ...
    d8_WeDontThinkTheX.text = "We don't think the Xsotan came from this galaxy, because we would have come across them a lot earlier if they did.\n\nAll we know is that there's a large mothership in the very center of the galaxy, which opens wormholes regularly. \n\nThey might even lead to another galaxy for all we know."%_t
